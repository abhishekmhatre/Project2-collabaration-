...
public class Notification {
	...
	private String rejectionReason; //If rejected ,reason behind that
	private boolean viewed; //true or false,if user is notifiedand user views the ntfctn---then true else false
	public int getId() {
		return id;
	}
